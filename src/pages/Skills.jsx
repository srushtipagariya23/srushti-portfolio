...
const Skills = () => {
  ...
  const skillCategories = [
    { id: "MOD-01", title: "Service Design", spec: "SPEC: JOURNEYS & ECOSYSTEMS", description: "Mapping complex systems and uncovering opportunities to shape end-to-end service experiences that feel intuitive, accessible, and deeply human-centred.", items: ["Journey Mapping", "Service Blueprinting", "Co-Design", "Rapid Prototyping", "Inclusive Services", "Stakeholder Mapping", "Usability Testing", "Systems Thinking"] },
    { id: "MOD-02", title: "Research & Insight", spec: "SPEC: DISCOVERY & SYNTHESIS", description: "Uncovering hidden needs through mixed-methods research, careful listening, and translating complex qualitative data into clear, actionable design directions.", items: ["Audience Research", "Qualitative Interviews", "Surveys", "Insight Synthesis", "Problem Framing", "Desk Research", "Mixed-Methods Research"] },
    { id: "MOD-03", title: "Strategy & Storytelling", spec: "SPEC: NARRATIVE & POSITIONING", description: "Translating insights into compelling narratives that align business goals with user trust, ensuring every touchpoint communicates clear value and purpose.", items: ["Brand Strategy", "Content Strategy", "Narrative Design", "Copywriting", "Communication Planning", "Workshop Facilitation", "Mentoring", "Stakeholder Communication", "Public Relations"] },
    { id: "MOD-04", title: "Design & Visuals", spec: "SPEC: PROTOTYPING & PRODUCTION", description: "Bringing concepts to life through rapid prototyping, high-fidelity visual design, and editorial layouts that prioritize clarity and user engagement.", items: ["Visual Storytelling", "Video Production & Editing", "Product Styling", "Product Photography", "Social Media Management", "Figma", "Adobe Suite", "Miro", "Canva"] }
  ];
